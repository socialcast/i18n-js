...
Gem::Specification.new do |s|
  s.name        = "socialcast-i18n-js"
  s.version     = I18n::Js::Version::STRING
  s.platform    = Gem::Platform::RUBY
  s.authors     = ["Nando Vieira", "Sean Cashin"]
  s.email       = ["fnando.vieira@gmail.com", "sean@socialcast.com"]
  s.homepage    = "http://rubygems.org/gems/socialcast-i18n-js"
